...
Name "${PRODUCT_NAME}"
Outfile "ElevaRemoteDesk-Setup-x64.exe"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "Publisher" "Eleva Business Solutions"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "HelpLink" "https://github.com/kaiquecrestan/eleva-remote-desk"
